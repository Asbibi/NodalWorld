...
public class NodalEditorBuilder {
	...
	*/ 
	public static JComponent buildGenerationEditor(GameManager game) {
		...
		disable(editor, new String[] {
			"Movement", "Death", 
			"Terrain Unit", "Filled Terrain", "Terrain Rectangle", "Terrain Ellipse", "Terrain Random", "Intersect Terrain", "Union Terrain", "Substract Terrain", "Invert Terrain", "Erode Terrain", "Expand Terrain",
			"Current Entity"
		});
