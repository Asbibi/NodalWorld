...
/**
* Result in the Union of 2 TerrainModels.
*/ 
public class TerrainModelUnion implements TerrainModel {
	...
	*/ 
	...
	/**
	* @param pos
	* @return true if the given position is inside one of the two terrain models
	*/ 
	@Override
